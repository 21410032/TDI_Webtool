...
base_data_df = pd.read_excel("C:/Users/tinky/TDI_Toool/TRI_base_data.xlsx")
...
base_data_df.to_excel("C:/Users/tinky/OneDrive/Documents/households_excel1.xlsx")
...
# print('HH_village_name_list')
# print(HH_village_name_list)
# print('unique_village_name')
# print(unique_village_name)
...
print(unique_tribes[0])
print(village_name_list[0])
...
cum_score_df.to_excel("C:/Users/tinky/OneDrive/Documents/households_excel2.xlsx")
print("Result Excel file saved successfully.")
...
HH_score_df.to_excel("C:/Users/tinky/OneDrive/Documents/households_excel3.xlsx")
print("Result Excel file saved successfully.")
